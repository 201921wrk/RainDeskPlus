...
// RainDeskPlus adapter (see IfActions.h / Logger.h / Mouse.h):
// ConfigParser / Skin live in `namespace raindock`.  Section itself stays
// global (upstream TUs copied verbatim); do NOT add it to the raindock block.
namespace raindock { class ConfigParser; class Skin; }
